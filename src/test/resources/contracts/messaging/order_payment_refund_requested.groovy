...
/*
 * Mirrors the real wire payload for payment-events / PAYMENT_REFUND_REQUESTED.
...
org.springframework.cloud.contract.spec.Contract.make {
    description("Should publish the serialized PAYMENT_REFUND_REQUESTED event to payment-events")
