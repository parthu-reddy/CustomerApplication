...
public class OpenApiGenerationTest {
    ...
    @org.springframework.boot.test.mock.mockito.MockBean
    private com.fooddelivery.customer.config.DynamicPricingConfig dynamicPricingConfig;


    @org.springframework.boot.test.mock.mockito.MockBean
    private com.fooddelivery.customer.service.DynamicPricingService dynamicPricingService;
    ...
    @org.springframework.boot.test.mock.mockito.MockBean
    private com.fooddelivery.customer.repository.ICustomerRepository iCustomerRepository;


    @org.springframework.boot.test.mock.mockito.MockBean
    private com.fooddelivery.customer.repository.CustomerAddressRepository customerAddressRepository;


    @org.springframework.boot.test.mock.mockito.MockBean
    private com.fooddelivery.order.repository.SupportTicketRepository supportTicketRepository;
