package com.fooddelivery.contract.consumer.customer.service;
...
public class MenuCacheInvalidationListenerTest {
    ...
    public void testConsumerIsWorking() {
        try {
            stubTrigger.trigger("trigger-menu-updated");
        } catch (Exception e) {
