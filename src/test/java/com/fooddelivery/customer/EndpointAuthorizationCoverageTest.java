...
class EndpointAuthorizationCoverageTest {
    ...
    private static final Set<String> RESOURCE_BINDING_VERIFIED_ELSEWHERE = Set.of(
            // The handler rejects an address whose customerId differs from the path customerId.
            "CustomerAddressController#deleteAddress",
            // The handler 404s unless order.deliveryExecutiveId equals the path driverId.
            "DriverMoneyController#fetchOrderEarnings",
            // The handler 404s unless order.restaurantId equals the path outletId.
            "RestaurantMoneyController#fetchOrderEarnings"
);
