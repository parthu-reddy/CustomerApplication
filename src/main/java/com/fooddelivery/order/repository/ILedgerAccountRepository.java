...
public interface ILedgerAccountRepository extends JpaRepository<LedgerAccount, UUID> {
    ...
    int insertIfNotExists(@org.springframework.data.repository.query.Param("id") UUID id, @org.springframework.data.repository.query.Param("ownerId") UUID ownerId, @org.springframework.data.repository.query.Param("ownerType") String ownerTypeStr);
}
