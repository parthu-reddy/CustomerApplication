...
public class InternalOrderController {
    ...
    public ResponseEntity<List<Order>> getActiveOrdersForDriver(@PathVariable UUID driverId) {
        ...
        List<Order> activeOrders = orderRepository.findActiveOrdersForDriver(driverId, cancelledStatuses, java.util.List.of(com.fooddelivery.common.enums.DeliveryStatus.DELIVERED, com.fooddelivery.common.enums.DeliveryStatus.FAILED, com.fooddelivery.common.enums.DeliveryStatus.CANCELLED));
    ...
    @PreAuthorize("hasAnyRole(\'ADMIN\', \'DELIVERY\')")
    @org.springframework.transaction.annotation.Transactional(readOnly = true)
    public ResponseEntity<List<Order>> getOrderHistoryForDriver(@PathVariable UUID driverId, @RequestParam(required = false) String date) {
        ...
        List<OrderStatus> cancelledStatuses = Arrays.asList(OrderStatus.CANCELLED, OrderStatus.CANCELLED_BY_RESTAURANT);
        List<Order> history = orderRepository.findHistoryOrdersForDriver(driverId, cancelledStatuses, java.util.List.of(com.fooddelivery.common.enums.DeliveryStatus.DELIVERED, com.fooddelivery.common.enums.DeliveryStatus.FAILED, com.fooddelivery.common.enums.DeliveryStatus.CANCELLED), startOfDay, endOfDay);
