...
public class DynamicPricingService {
    ...
    public PricingBreakdown calculatePricing(BigDecimal foodCost, BigDecimal distanceKm) {
        ...
        charges.add(createCharge(com.fooddelivery.common.enums.ChargeCategory.FOOD_COST, 
            com.fooddelivery.order.enums.ChargeEntityType.PLATFORM, com.fooddelivery.order.enums.ChargeEntityType.RESTAURANT, foodCost));
        
        // 1. Customer pays Fixed Platform Fee
        if (config.getFixedPlatformFee().compareTo(BigDecimal.ZERO) > 0) {
            charges.add(createCharge(com.fooddelivery.common.enums.ChargeCategory.PLATFORM_FIXED_FEE, 
                com.fooddelivery.order.enums.ChargeEntityType.CUSTOMER, com.fooddelivery.order.enums.ChargeEntityType.PLATFORM, config.getFixedPlatformFee()));
        }
        
        // 2. Customer pays Driver
        if (custPaysDe.compareTo(BigDecimal.ZERO) > 0) {
            charges.add(createCharge(com.fooddelivery.common.enums.ChargeCategory.DELIVERY_FEE, 
                com.fooddelivery.order.enums.ChargeEntityType.CUSTOMER, com.fooddelivery.order.enums.ChargeEntityType.DRIVER, custPaysDe));
        }
        
        // 3. Restaurant pays Fixed Platform Fee
        if (config.getFixedPlatformFee().compareTo(BigDecimal.ZERO) > 0) {
            charges.add(createCharge(com.fooddelivery.common.enums.ChargeCategory.PLATFORM_FIXED_FEE, 
                com.fooddelivery.order.enums.ChargeEntityType.RESTAURANT, com.fooddelivery.order.enums.ChargeEntityType.PLATFORM, config.getFixedPlatformFee()));
        }
        
        // 4. Restaurant pays Driver
        if (restPaysDe.compareTo(BigDecimal.ZERO) > 0) {
            charges.add(createCharge(com.fooddelivery.common.enums.ChargeCategory.DELIVERY_FEE, 
                com.fooddelivery.order.enums.ChargeEntityType.RESTAURANT, com.fooddelivery.order.enums.ChargeEntityType.DRIVER, restPaysDe));
        }
        
        // 5. Restaurant pays Platform Bonus
        if (platformBonus.compareTo(BigDecimal.ZERO) > 0) {
            charges.add(createCharge(com.fooddelivery.common.enums.ChargeCategory.PLATFORM_BONUS, 
                com.fooddelivery.order.enums.ChargeEntityType.RESTAURANT, com.fooddelivery.order.enums.ChargeEntityType.PLATFORM, platformBonus));
        }
        ...
        if (sgstAmount.compareTo(BigDecimal.ZERO) > 0) {
            charges.add(createCharge(com.fooddelivery.common.enums.ChargeCategory.SGST, 
                com.fooddelivery.order.enums.ChargeEntityType.CUSTOMER, com.fooddelivery.order.enums.ChargeEntityType.RESTAURANT, sgstAmount));
        }
        
        // 7. Customer pays CGST to Restaurant
        if (cgstAmount.compareTo(BigDecimal.ZERO) > 0) {
            charges.add(createCharge(com.fooddelivery.common.enums.ChargeCategory.CGST, 
                com.fooddelivery.order.enums.ChargeEntityType.CUSTOMER, com.fooddelivery.order.enums.ChargeEntityType.RESTAURANT, cgstAmount));
        }
    ...
    private com.fooddelivery.order.entity.OrderCharge createCharge(
            com.fooddelivery.common.enums.ChargeCategory category, 
            com.fooddelivery.order.enums.ChargeEntityType payer, 
            com.fooddelivery.order.enums.ChargeEntityType payee, 
            BigDecimal amount) {
        
        return com.fooddelivery.order.entity.OrderCharge.builder()
