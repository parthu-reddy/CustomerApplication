...
public class OrderResponse {
     ...
     *
     * <p>The customer's order view could not say how an order was paid, and the UI patched the gap
     * by declaring paymentMethod on its own Order type, over a DTO that never sent it.
     */
