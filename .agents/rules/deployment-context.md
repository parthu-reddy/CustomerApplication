...
| **Oracle VM Public IP** | `140.245.225.221` |
| **SSH Key Path** | `/Users/parthureddy/Documents/OracleSSH/ssh-key-2026-07-17.key` |
...
- **NEVER use** `localhost`, `127.0.0.1`, or the raw Oracle IP `140.245.225.221` in any HTTP test commands.
...
ssh -i /Users/parthureddy/Documents/OracleSSH/ssh-key-2026-07-17.key ubuntu@140.245.225.221 "docker ps --format 'table {{.Names}}\t{{.Status}}'"
```
